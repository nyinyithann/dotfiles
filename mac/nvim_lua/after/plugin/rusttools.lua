...
rt.setup({
    ...
    server = {
        ...
        on_attach = function(client, bufnr)
            ...
            vim.keymap.set("n", "<space>k", rt.hover_actions.hover_actions, { buffer = bufnr })
            ...
            vim.keymap.set("n", "<F5>", "<Cmd>RustRun<CR>", { buffer = bufnr })
            vim.keymap.set("n", "<F6>", "<Cmd>RustRunnables<CR>", { buffer = bufnr })
        end,
        settings = {
            ["rust-analyzer"] = {
                lens = {
